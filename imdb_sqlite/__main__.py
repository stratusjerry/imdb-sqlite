...
TSV_TABLE_MAP = OrderedDict([
    ...
    ('title.basics.tsv.gz',
        ('titles', OrderedDict([
            ('tconst',            Column(name='title_id', type='VARCHAR PRIMARY KEY', index=True)),
    ...
    ('title.principals.tsv.gz',
        ('crew', OrderedDict([
            ...
            ('job',               Column(name='job', index=True)),
    ...
    ('title.crew.tsv.gz',
        ('production', OrderedDict([
            ('tconst',            Column(name='title_id', type='VARCHAR PRIMARY KEY', index=True)),
            ('directors',         Column(name='directors', index=True)),
            ('writers',           Column(name='writers', index=True)),
        ]))),
])
